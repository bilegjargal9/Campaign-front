...
const Dial = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <h1 className="text-3xl font-bold mb-6">Дуудлага хийх систем</h1>
                    ...
                    <tr key={number.number} className={`hover:bg-gray-50 ${number.isSelected ? "bg-blue-50" : ""}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex space-x-2">
                          ...
                          >
                            {number.isSelected ? "Сонгогдсон" : "Сонгох"}
                          </button>
      ...
      {/* Schedules Component */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Дуудлагын хуваарь</h2>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-4">
          ...
          >
            <option value="">-- Шинэ Template үүсгэх --</option>
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-gray-500 mt-1">
            {language === 'en' 
              ...
              : 'For Mongolian messages, we will generate audio using Chimege TTS'}
          </p>
        </div>
  ...
  <div className="mt-2">
    <p className="text-sm text-green-600">
      Audio URL: {getRelativeAudioPath(templateFormData.audio_url)}
    </p>
    <audio
      key={getRelativeAudioPath(templateFormData.audio_url)}
      controls
    ...
    >
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4 flex items-center">Хүлээн авагчид</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Кампанит ажил сонгох (Optional)
            </label>
            <Select
              isClearable
        ...
        <div className="mb-4">
          <h3 className="text-md font-medium mb-2">Хүлээн авагчид</h3>
          <div className="border rounded-md p-3 bg-gray-50">
            <p>Нийт Хүлээн авагчид: {recipients.length}</p>
            {recipients.length > 0 && (
              <div className="mt-2">
                <p className="text-sm text-gray-600">
                   Эхний хэрэглэгчид: {recipients.slice(0, 3).map(r => r.name || r.customer.phone_number).join(', ')}
                  {recipients.length > 3 && '...'}
                </p>
              </div>
            )}
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        <h2 className="text-xl font-semibold mb-4">Илгээх төрөл</h2>
          ...
          <div className="mb-4">
            ...
            {showingPreview && (
              <div className="p-3 border rounded-md bg-blue-50">
                ...
                <p>Хувиарлагдсан нийт дуудлага: {schedulingPreview.totalCalls}</p>
                {schedulingPreview.dayDistribution.map((day, idx) => (
                  <p key={idx} className="text-sm">
                    {day.date.toLocaleDateString()}: {day.count} дуудлага
                  </p>
                ))}
              </div>
            )}
